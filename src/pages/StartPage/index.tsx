        ...
        <Settings active={openInfo} setActive={setOpenInfo}>
          <>
            ...
            <p>
              ...
              карточек, открывая по две карточки сразу. <br /> Забрать пару
              карточек получиться только открыв две одинаковые. Открыв карточки
              с разными картинками, они перевернуться обратно, оставаясь в игре.
            </p>
